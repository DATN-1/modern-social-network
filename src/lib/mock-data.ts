...
export const currentUser: User = {
  ...
  name: "Minh Nguyen",
  username: "minh",
  avatarColor: "from-indigo-500 via-sky-500 to-teal-500",
  bio: "Designer & coffee enthusiast. Building beautiful things on the web. ✨",
  coverColor: "from-indigo-500 via-sky-500 to-teal-500",
  verified: true,
};
...
export const users: User[] = [
  currentUser,
  {
    ...
    name: "Linh Pham",
    username: "linhpham",
    avatarColor: "from-cyan-400 via-sky-500 to-blue-500",
  ...
  },
  {
    ...
    name: "Mai Vu",
    username: "maiv",
    avatarColor: "from-amber-400 via-orange-500 to-red-500",
  ...
  },
  {
    ...
    name: "Hoang Nam",
    username: "hoangnam",
    avatarColor: "from-sky-400 via-indigo-500 to-indigo-700",
...
export const stories: Story[] = [
  { id: "s_me", authorId: "u_me", gradient: "from-indigo-500 via-sky-500 to-teal-500", emoji: "✨" },
  { id: "s_1", authorId: "u_1", gradient: "from-cyan-400 via-sky-500 to-blue-500", emoji: "🍜" },
  { id: "s_2", authorId: "u_2", gradient: "from-sky-400 via-cyan-500 to-blue-600", emoji: "💻" },
  { id: "s_3", authorId: "u_3", gradient: "from-amber-400 via-orange-500 to-red-500", emoji: "📸" },
  { id: "s_4", authorId: "u_4", gradient: "from-emerald-400 via-teal-500 to-cyan-600", emoji: "🏃" },
  { id: "s_5", authorId: "u_5", gradient: "from-sky-400 via-blue-500 to-indigo-600", emoji: "🎧", seen: true },
  { id: "s_6", authorId: "u_6", gradient: "from-yellow-400 via-orange-500 to-red-500", emoji: "🧗", seen: true },
  { id: "s_7", authorId: "u_7", gradient: "from-amber-400 via-orange-500 to-red-500", emoji: "🎨" },
  { id: "s_8", authorId: "u_8", gradient: "from-sky-400 via-indigo-500 to-indigo-700", emoji: "🚀" },
];
